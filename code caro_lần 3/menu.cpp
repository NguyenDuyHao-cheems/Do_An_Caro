    ...
    if (curlang == 0) {
        ...
        while (true) {
            ...
            if (move == 80 || move == 'S') {
                ...
                switch (y) {
                case menu1_y:
                    GotoXY(x + 4, y); cout << "     NEW GAME     ";
                    break;
                case menu1_y + 3:
                    GotoXY(x + 4, y); cout << "     LOAD GAME    ";
                    break;
                case menu1_y + 6:
                    GotoXY(x + 4, y); cout << "       HELP       ";
                    break;
                case  menu1_y + 9:
                    GotoXY(x + 4, y); cout << "       ABOUT      ";
                    break;
                case menu1_y + 12:
                    GotoXY(x + 4, y); cout << "      SETTING     ";
                    break;
                case menu1_y + 15:
                    GotoXY(x + 4, y); cout << "       EXIT       ";
                    break;
                }
        ...
        while (true) {
            ...
            if (move == 80 || move == 'S') {
                ...
                switch (y) {
                case menu1_y:
                    GotoXY(x + 4, y); cout << "   TRO CHOI MOI   ";
                    break;
                case menu1_y + 3:
                    GotoXY(x + 4, y); cout << "     TAI GAME     ";
                    break;
                case menu1_y + 6:
                    GotoXY(x + 4, y); cout << "     HUONG DAN    ";
                    break;
                case  menu1_y + 9:
                    GotoXY(x + 4, y); cout << "     THONG TIN    ";
                    break;
                case menu1_y + 12:
                    GotoXY(x + 4, y); cout << "      CAI DAT     ";
                    break;
                case menu1_y + 15:
                    GotoXY(x + 4, y); cout << "       THOAT      ";
                    break;
                }
                if (y == menu1_y + 15) y = menu1_y;
                else y += 3;
...
void printMenu() {
    ...
    if (curlang == 0) {
        ...
        GotoXY(menu1_x + 5, menu1_y + 12); cout << "     SETTING     " << endl;
        txtColor((0 << 4) | 14);
        GotoXY(menu1_x + 4, menu1_y); cout << "     NEW GAME     ";
        MenuSelection();
    }
    else {
        txtColor((15 << 4) | 4);
...
void NewGame() {
    ...
    if (curlang == 0) {
        ...
        Box(137 - 10, 7, 28, 6);
        drawPvP(141 - 10, 8);
        DrawFull(36 - 10, 20, 88, 8, (11 << 4) | 15, 32);
        drawCountdown(38 - 10, 22);
        txtColor((15 << 4) | 0);
        Box(135 - 10, 20, 32, 8);
        Box(137 - 10, 21, 28, 6);
        draw15s(139 - 10, 22);
        DrawFull(36 - 10, 36, 132, 8, (12 << 4) | 15, 32);
        drawPlay(88 - 10, 37);
        NewGameSelection();
...
void loadMenuPlusV() {
    ...
    DrawFull(x, y, w, h, 195, 197);
    DrawFull(x + 2, y + 1, w - 4, h - 2, 119, 32);
    GotoXY(x + 3, y + 2); cout << "TIM: ";
    txtColor(112);
    GotoXY(x + 9, y + 2); cout << "An F de tim";
    txtColor(116);
    DrawFull(x + 33, y + 1, w + 2, h, 136, 32);
    DrawFull(x + 31, y, w + 1, h, 195, 197);
    DrawFull(x + 33, y + 1, w - 3, h - 2, 119, 32);
    txtColor(112);
    GotoXY(x + 34, y + 2); cout << "So luong ban luu: ";
    txtColor(116);
}

void drawballE(int x, int y) {
    char ball[17][13] = {
        "    4444    ",
        "  440FF044  ",
        " 4008008004 ",
    ...
    for (int i = 0; i < 17; i++)
    {
        DrawLine(ball[i], 13, x, y);
        y++;
    }
}

void drawballS(int x, int y) {
    char ball[17][13] = {
        "    4444    ",
        "  440FF044  ",
        " 4008008004 ",
