...
void ve3() {
    ...
    DrawFull(30, 8, w + 12, 10, 31, 32);
    for (int j = 10; j < 18; j++) {
        DrawFull(32, j, 1, 0.5, 255, 32);
    }
    for (int j1 = 12; j1 < 16; j1++) {
        DrawFull(39, j1, 1, 0.5, 255, 32);
    }
    for (int j2 = 32; j2 < 37; j2++) {
        DrawFull(j2, 10, 1, 0.5, 255, 32);
    }
    for (int j3 = 32; j3 < 37; j3++) {
        DrawFull(j3, 17, 1, 0.5, 255, 32);
    }
    DrawFull(37, 11, 1, 0.5, 255, 32);
    DrawFull(37, 16, 1, 0.5, 255, 32);
    for (int j4 = 10; j4 < 18; j4++) {
        DrawFull(44, j4, 1, 0, 255, 32);
    }
    DrawFull(50, 12, 1, 0.5, 255, 32);
    for (int j2 = 44; j2 < 48; j2++) {
        DrawFull(j2, 10, 1, 0.5, 255, 32);
    }
    for (int j2 = 44; j2 < 48; j2++) {
        DrawFull(j2, 14, 1, 0.5, 255, 32);
    }
    DrawFull(48, 11, 1, 0.5, 255, 32);
    DrawFull(48, 13, 1, 0.5, 255, 32);
    int h4 = 47;
    for (int j2 = 14; j2 < 18; j2++) {
        DrawFull(h4, j2, 1, 0.5, 255, 32);
        h4 += 1;
    }
    int h5 = 54;
    for (int j2 = 17; j2 > 9; j2--) {
        DrawFull(h5, j2, 1, 0.5, 255, 32);
        h5 += 1;
    }
